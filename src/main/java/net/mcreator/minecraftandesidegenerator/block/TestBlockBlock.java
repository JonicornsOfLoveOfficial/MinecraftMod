...
public class TestBlockBlock extends MinecraftAndesideGeneratorElements.ModElement {
	@ObjectHolder("minecraftandesidegenerator:testblock")
	public static final Block block = null;
	public TestBlockBlock(MinecraftAndesideGeneratorElements instance) {
		super(instance, 16);
	}
